...
public class WriteWordFragment extends Fragment implements View.OnClickListener {
    private int mItemId;
...
//        tv_char_0.setVisibility(View.GONE);
    ...
    public void setmWord(int position, View view, String word, boolean setWord) {
